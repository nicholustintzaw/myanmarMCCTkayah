...
```{r fcsn1plot, echo = FALSE, eval = TRUE, fig.cap = "Vitamin A food consumption score classification by location type", fig.width = 12, fig.height = 9, fig.align = "center", fig.pos = "H"}
tabLong <- tidyr::pivot_longer(data = tab,
                               cols = vita1:vita3,
                               names_to = "indicators", values_to = "estimate")
...
```{r fcsn2plot, echo = FALSE, eval = TRUE, fig.cap = "Vitamin A food consumption score classification by wealth quintiles", fig.width = 12, fig.height = 9, fig.align = "center", fig.pos = "H"}
ggplot(data = tabLong[!tabLong$strata %in% c("Rural", "Urban", "Hard-to-reach") & tabLong$state == "Kayah", ], 
       aes(x = strata, y = estimate, fill = indicators)) +
  geom_col(width = 0.5) +
  geom_text(aes(group = indicators, label = paste(round(estimate, digits = 1), "%", sep = "")), 
...
```{r fcsn3plot, echo = FALSE, eval = TRUE, fig.cap = "Protein food consumption score classification by location type", fig.width = 12, fig.height = 9, fig.align = "center", fig.pos = "H"}
tabLong <- tidyr::pivot_longer(data = tab,
...
```{r fcsn4plot, echo = FALSE, eval = TRUE, fig.cap = "Protein food consumption score classification by wealth quintiles", fig.width = 12, fig.height = 9, fig.align = "center", fig.pos = "H"}
ggplot(data = tabLong[!tabLong$strata %in% c("Rural", "Urban", "Hard-to-reach") & tabLong$state == "Kayah", ], 
       aes(x = strata, y = estimate, fill = indicators)) +
  geom_col(width = 0.5) +
  geom_text(aes(group = indicators, label = paste(round(estimate, digits = 1), "%", sep = "")), 
...
```{r lcsi1plot, echo = FALSE, eval = TRUE, fig.cap = "Livelihoods-based coping strategies index by location type", fig.width = 12, fig.height = 9, fig.align = "center", fig.pos = "H"}
tabLong <- tidyr::pivot_longer(data = tab,
...
```{r lcsi2plot, echo = FALSE, eval = TRUE, fig.cap = "Livelihoods-based coping strategies index by wealth quintiles", fig.width = 12, fig.height = 9, fig.align = "center", fig.pos = "H"}
ggplot(data = tabLong[!tabLong$strata %in% c("Rural", "Urban", "Hard-to-reach") & tabLong$state == "Kayah", ], 
       aes(x = strata, y = estimate, fill = indicators)) +
  geom_col(width = 0.5) +
  geom_text(aes(group = indicators, label = paste(round(estimate, digits = 1), "%", sep = "")), 
